...
Public download center and hosted web app:

- Download center: <https://lelegiptv.ddns.net/>
- Web app home: <https://lelegiptv.ddns.net/home/>

The PWA manifest is configured for `/home/`; browsers show the native install
prompt on HTTPS or localhost.
