...
2. `01-runtime-flows.md` for end-to-end flows such as login, catalog loading,
   EPG loading, playback, downloads, backup, and native packaging.
...
6. `05-native-tauri-android.md` for legacy Rust/Tauri context plus current
   Flutter/Tizen notes.
...
- selected legacy context under `src-tauri`
- `tests`
- `docs/src`
