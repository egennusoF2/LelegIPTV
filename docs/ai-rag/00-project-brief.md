...
- iOS/iPhone and iPadOS are Flutter targets. Tester distribution uses the
  signed TestFlight IPA generated by `scripts/package-ios-testflight-ipa.sh` and
  uploaded with `scripts/upload-ios-testflight.sh`.
