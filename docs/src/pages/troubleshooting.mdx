...
<Callout type="warning">
  This was fixed in version 1.5. If you're seeing a black PiP window, you're on an older build - update to the latest release from the Play Store, the Microsoft Store, or [GitHub Releases](https://github.com/egennusoF2/LelegIPTV/releases/latest).
</Callout>
