...
Some providers encode TV listing data in a way that looks like gibberish until decoded. The app handles this automatically. If you still see scrambled text after refreshing, it's a provider-side issue - [file an issue](https://github.com/egennusoF2/LelegIPTV/issues/new/choose) and include the affected channel.
...
<Callout type="warning">
  This was fixed in version 1.5. If you're seeing a black PiP window, you're on an older build - rebuild the current local artifact for your target platform or install a newer artifact from [GitHub Releases](https://github.com/egennusoF2/LelegIPTV/releases/latest).
</Callout>
